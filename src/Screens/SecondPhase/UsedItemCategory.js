    ...
    <View style={{marginBottom: 20}}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      SharePost({
                        ...
                        image:
                          'https://www.kanpid.com/assets/admin_assets/admin_assets/category-image/' +
                          item.product_image,
                      }).then(res => {
                        console.log(res);
                      });
      ...
      <ActionSheet
        ...
        <View
          ...
          <Text style={{color: '#4AAB7E', fontSize: 16}}>Please login</Text>
          <TouchableOpacity
            style={{marginTop: 30}}
            onPress={() => {
