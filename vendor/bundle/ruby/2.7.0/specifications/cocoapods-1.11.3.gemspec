# -*- encoding: utf-8 -*-
# stub: cocoapods 1.11.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<cocoapods-core>.freeze, ["= 1.11.3"])
    s.add_runtime_dependency(%q<claide>.freeze, [">= 1.0.2", "< 2.0"])
    s.add_runtime_dependency(%q<cocoapods-deintegrate>.freeze, [">= 1.0.3", "< 2.0"])
    s.add_runtime_dependency(%q<cocoapods-downloader>.freeze, [">= 1.4.0", "< 2.0"])
    ...
    s.add_runtime_dependency(%q<xcodeproj>.freeze, [">= 1.21.0", "< 2.0"])
    ...
    s.add_dependency(%q<xcodeproj>.freeze, [">= 1.21.0", "< 2.0"])
    ...
    s.add_dependency(%q<ruby-macho>.freeze, [">= 1.0", "< 3.0"])
